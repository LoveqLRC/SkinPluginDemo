...
import rc.loveq.framelibrary.skin.SkinResource;
import rc.loveq.framelibrary.skin.attr.SkinAttr;
import rc.loveq.framelibrary.skin.attr.SkinView;
import rc.loveq.framelibrary.skin.callback.ISkinChangeListener;
import rc.loveq.framelibrary.skin.support.SkinAppCompatViewInflater;
import rc.loveq.framelibrary.skin.support.SkinAttrSupport;
...
public class BaseSkinActivity extends AppCompatActivity implements ISkinChangeListener, LayoutInflaterFactory {
    // 后面会写插件换肤 预留的东西
